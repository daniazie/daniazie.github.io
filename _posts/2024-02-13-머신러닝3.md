	...
	- $z = ax_1 + bx_2 + c$
		- z는 어떤 값도 가능하지만 확률이 되려면 시그모이드 함수(또는 로지스틱 함수)를 이용하여 0~1 사이 값이 되어야 한다.
			- 시그모이드 함수: $\sigma = \frac{1}{1+e^{-z}}$
				 ...
				 ![photo 1](/assets/img/posts/Pasted image 20240212220825.png)
...
![photo 2](/assets/img/posts/Pasted image 20240213043359.png)
...
![photo 3](/assets/img/posts/Pasted image 20240213052350.png)
