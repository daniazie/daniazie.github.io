...
![photo 1](assets/img/posts/Pasted image 20240131070239.png)
...
- 파이썬의 대표적인 배열 라이브러리
	- 2차원 리스트를 표현할 수 있다
		![photo 2](assets/img/posts/Pasted image 20240131071644.png)
...
plt.show()
```
![photo 3](assets/img/posts/Pasted image 20240131084318.png)
...
![photo 4](assets/img/posts/Pasted image 20240131085242.png)
